...
@Component({
    selector: 'app-update-disciplinas',
    templateUrl: './update-disciplinas.component.html',
    styles: [`.ng-valid.touched{ border: 1px solid red;}`]
})
export class UpdateDisciplinasComponent {
    ...
    guardarCambios() {
        ...
        this.catalogosService.updateDisciplina(this.disciplina)
            .subscribe(
            (data) => {
                console.log(data)
            },
